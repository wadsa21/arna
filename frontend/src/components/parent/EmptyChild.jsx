...
/** Заглушка, когда у родителя ещё нет ни одного ребёнка. */
export default function EmptyChild() {
  const { t } = useTranslation();
  const [open, setOpen] = useState(false);
  return (
    <div className="flex flex-col items-center justify-center gap-5 py-24 text-center">
      <div className="flex h-24 w-24 animate-float items-center justify-center rounded-3xl bg-gradient-brand text-5xl shadow-neon-primary">
